...
guardarán en un diccionario en el que la clave de cada 
cliente será su NIF, y el valor será otro diccionario 
...
menú: (1) Añadir cliente, (2) Eliminar cliente, (3) 
Mostrar cliente, (4) Listar todos los clientes, 
(5) Listar clientes preferentes, (6) Terminar. En 
función de la opción elegida el programa tendrá que
hacer lo siguiente:
...
while opcion!= '6':
    if opcion=='1':
        ...
        teléfono= input("Por favor, ingresa el teléfono: ")
        correo= input("Por favor, ingresa elc orreo: "), 
        cliente={'nombre': nombre, 'direccion': direccion,'teléfono': teléfono,'correo': correo }
    ...
    if opcion=='2':
        ...
        if nif in clientes:
            ...
            print(f"No existe el usuario con el nif: {nif}")
    if opcion=='3':
        nif=input("Por favor, ingresa el NIF del cliente: ")
        if nif in clientes:
            print('NIF: ', nif)
